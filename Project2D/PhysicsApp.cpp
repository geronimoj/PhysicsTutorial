...
bool PhysicsApp::startup() {
	...
	m_physicsScene->AddActor(new Box(glm::vec2(0, 0), false, glm::vec2(0, 0), 3.0f, glm::vec4(1, 1, 1, 1), glm::vec2(40, 10), 1, 15));
...
void PhysicsApp::SphereTest()
{
	...
	//m_physicsScene->AddActor(new Sphere(glm::vec2(50, 0), false, glm::vec2(0, 0), 1.0f, 15, glm::vec4(0, 1, 0, 1), 300, 0, 0, 1));
}
