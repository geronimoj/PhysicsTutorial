...
//	Sphere* ball1 = new Sphere(glm::vec2(-40, 0), false, glm::vec2(10, 30), 3.0f, 10, glm::vec4(1, 0, 0, 1), 0, 1, 0);
//	Sphere* ball2 = new Sphere(glm::vec2(40, 0), false, glm::vec2(-10, 30), 6.0f, 20, glm::vec4(0, 1, 0, 1));
