...
bool PhysicsApp::startup() {
	...
	//Box* box1 = new Box(glm::vec2(0, 0), false, glm::vec2(0, 50), 3.0f, glm::vec4(1, 1, 1, 1), glm::vec2(20, 10), 0, 50, 0, 0, 0.5f);
...
void PhysicsApp::SphereTest()
{
	...
	m_physicsScene->AddActor(new Sphere(glm::vec2(30, -35), false, glm::vec2(0, 0), 3.0f, 15, glm::vec4(0, 1, 0, 1)));
}
